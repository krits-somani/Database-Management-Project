...
void ExecuteQuery(PGconn* conn,char* query){
    PQexec(conn, "set search_path to car_renting;");
...
void ExecuteUpdate(PGconn* conn,char* command){
    PQexec(conn, "set search_path to estore;");
...
int main()
{
  const char *conninfo = "dbname=201401024 user=201401024 password=201401024 hostaddr=10.100.71.21 port=5432";
